            ...
            if (href.indexOf(domain.toLowerCase()) != -1 && (itemClassName.indexOf('dimmed') == -1)) {
                ...
                if ((!editedPosts.includes(item.id)) && (item.id.toString().length > 5)) {
                  ...
                  console.log(item.id + " " + href);
                    ...
                    div.innerHTML = '<center><h1 class="overlay">This article was flagged as ' + bannedReasons[i].toLowerCase() + '. It may be unreliable.</h1><h4 class="overlay">To read, click within this overlay. </a> </h4></center><br><a class="button" href="">Dispute</a>';
